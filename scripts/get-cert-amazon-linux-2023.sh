...
# Скрипт для получения SSL сертификата на Amazon Linux 2023
# Выполните на EC2: bash scripts/get-cert-amazon-linux-2023.sh
...
echo "=========================================="
echo "🔒 Получение SSL сертификата на Amazon Linux 2023"
echo "=========================================="
echo ""
...
echo "   scp -i your-key.pem ec2-user@YOUR_EC2_IP:/tmp/ssl-certs/* ./certs/"
echo ""
